...
// ======================================================
// PALETTE CONSTANTS (Custom Theme Colors & Design Tokens)
// ======================================================
class AppPalette {
  ...
  static const Color danger = Color(0xFFEF4444); // Crimson Alert Accent
  ...
  static const Color sidebarBg = Color(0xFF0F172A); // Slate-900 Dark Sidebar
  static const Color sidebarActive = Color(0xFF1E293B); // Slate-800 Active Nav Tile
}
